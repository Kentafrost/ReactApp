...
with open(f"{current_dir}/delete_gmail_string.json", "r", encoding="utf-8") as f:
...
def delete_gmails():
    ...
    for message in messages:
        ...
        search_subjects = search_words["search_subjects"]
        search_content = search_words["search_content"]
        search_sender = search_words["search_sender"]
