# Create Folder and move files in specific directory to appropriate ones
...
4. Check the libraries installed in your python environment.
5. Invoke main.py script.